...
let questions = [
  {
    ...
    options: ["null", "0", "Depends upon the type of variable", "Not assigned"],
  },
  {
    numb: 2,
  ...
  {
    numb: 4,
    question: "Which puts the cursor on the next line after printing a String?",
    answer: "print()",
    options: ["next()", "nextLine()", "println()", "print()"],
  },
  {
    numb: 5,
    question: "Which identifier is not legal in java?",
